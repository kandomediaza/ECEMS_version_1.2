...
if(isset($_REQUEST['delete_id']))
{
 ...
 $Vendor_ID=$_REQUEST['delete_id']; //get delete_id and store in $id variable
  
 $select_stmt= $db->prepare('SELECT * FROM vendors WHERE jVendor_ID =:Vendor_ID'); //sql select query
 $select_stmt->bindParam(':Vendor_ID',$Vendor_ID);
 $select_stmt->execute();
 $row=$select_stmt->fetch(PDO::FETCH_ASSOC);
  
 //delete an orignal record from db
 $delete_stmt = $db->prepare('DELETE FROM vendors WHERE Vendor_ID =:Vendor_ID');
...
<html lang="en">
  ...
  ?></p>
                  ...
                  <div class="card-body">
                    <div class="d-flex justify-content-between flex-wrap">
                      ...
                      <div>
                       ...
                       <p>Here you can add/update/delete and archive all vendors registered on ECEMS. ALL VENDORS WHO PURCHASE FROM EC MUST BE REGISTERED ON ECEMS!
              </div>
    ...
    <tbody>
 <?php
 $select_stmt=$db->prepare("SELECT * FROM vendors"); //sql select query
 $select_stmt->execute();
 ...
 ?>
        ...
        <tr>
            ...
            <td><a href="editvendors.php?update_id=<?php echo $row['Vendor_ID']; ?>" class="btn btn-success" onclick="return confirm('Please be careful when editing this Vendor! Do not remove important information.. Click OK if you understand....');">View | Edit</a></td>
             <td><a href="archivevendor.php?archive_id=<?php echo $row['Vendor_ID']; ?>" name="btn_archive" class="btn btn-warning" onclick="return confirm('You are about to send this Vendor to the Archive database. Please only press OK if you understand that this cannot be undone.');">Archive</a></td>
            <td><a href="?delete_id=<?php echo $row['Vendor_ID']; ?>" class="btn btn-danger" onclick="return confirm('Are you REALLY sure you want to delete this Vendor? Press Cancel if this was a mistake, or press OK to delete this record from ECEMS');">Delete</a></td>
