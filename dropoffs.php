...
<html lang="en">
  ...
  ?></p>
                ...
                <div class="submenu">
                  <ul class="submenu-item">
                    ...
                    <li class="nav-item">
					 ...
					 <li class="nav-item">
                      <a class="nav-link" href="sdcert.php">Safe Disposal Cert.</a>
                    </li>
    ...
    <thead>
        <tr>
            <th><b>Drop-Off ID</b></th>
            <th><b>Date</b></th>
            <th><b>Client Name</b></th>
            <th><b>Contact Number</b></th>
            <th><b>Drop-Off Image</b></th>
            <th><b>View | Edit</b></th>
            <th><b>Archive</b></th>
            <th><b>Delete</b></th>
        </tr>
    ...
    <tbody>
 <?php
 $select_stmt=$db->prepare("SELECT * FROM dropoffs"); //sql select query
 $select_stmt->execute();
 ...
 ?>
        ...
        <tr>
            <td><?php echo $row['tbl_image_id']; ?></td>
             <td><?php echo $row['date']; ?></td>
            <td><?php echo $row['customer_name']; ?></td>
             <td><?php echo $row['customer_phone']; ?></td>
          <td><?php if($row['image_file'] != ""): ?>
									<img src="uploadedimages/<?php echo $row['image_file']; ?>" width="100px" height="100px" style="border:1px solid #333333;">
									<?php else: ?>
									<img src="uploadedimages/default.png" width="100px" height="100px" style="border:1px solid #333333;">
									<?php endif; ?></td>
              
            <td><a href="editdropoffs.php?update_id=<?php echo $row['dropoffID']; ?>" class="btn btn-success" onclick="return confirm('Please be careful when editing this job card! Do not remove important information.. Click OK if you understand....');">View | Edit</a></td>
             <td><a href="archivedropoffs.php?archive_id=<?php echo $row['dropoffID']; ?>" name="btn_archive" class="btn btn-warning" onclick="return confirm('You are about to send this Job Card to the Archive database. Please only press OK if you have invoiced this client, inserted the invoice number into ECEMS and the repair has been paid for and collected by the customer and is no longer with us....');">Archive</a></td>
            <td><a href="?delete_id=<?php echo $row['dropoffID']; ?>" class="btn btn-danger" onclick="return confirm('Are you REALLY sure you want to delete this Job Card? Press Cancel if this was a mistake, or press OK to delete this record from ECEMS');">Delete</a></td>
