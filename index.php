					...
					<div class="card fat">
						<div class="card-body">
							<h4 class="card-title">ECEMS LOGIN PAGE</h4>
														<form method="POST" action="login_auth.php" class="my-login-validation" novalidate="">
...
<div class="invalid-feedback">
 ...
 <input type="password" name="txt_password" class="form-control" placeholder="enter password" value="" required />
<div class="invalid-feedback">
