<?php
 ...
 if(!isset($_SESSION['employee_login'])) //check unauthorize user not direct access in "user_home.php" page
 {
 ...
 if(isset($_SESSION['tech_login'])) //check employee login user not access in "employee_home.php" page
 {
          ...
          <div class="content-wrapper pb-0">
            <div class="page-header flex-wrap">
              <div class="header-left">
                  <a href="addnewrecyclables.php" class="btn btn-outline-primary mb-2 mb-md-0" role="button">Add New Entry</a>
              ...
              <div class="col-md-12 stretch-card grid-margin">
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex justify-content-between flex-wrap">
                      <div>
                        <div class="card-title mb-0">Recyclables Overview (Current Month)</div>
...
$sql = "SELECT COUNT(*) AS num FROM daily_recyclables WHERE subgrade_bin = ?";
...
echo $row['num'];
?> </h4>
                              <span class="font-10 font-weight-semibold text-muted">SUBGRADE</span>
                            </div>
                          </div>
                          <div class="d-flex mr-3 mt-2 mt-sm-0">
