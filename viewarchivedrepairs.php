...
if(isset($_REQUEST['delete_id']))
{
 ...
 $select_stmt= $db->prepare('SELECT * FROM archived_repairs WHERE job_number =:job_number'); //sql select query
 $select_stmt->bindParam(':job_number',$job_number);
 $select_stmt->execute();
 $row=$select_stmt->fetch(PDO::FETCH_ASSOC);
  
 //delete an orignal record from db
 $delete_stmt = $db->prepare('DELETE FROM archived_repairs WHERE job_number =:job_number');
 $delete_stmt->bindParam(':job_number',$job_number);
 $delete_stmt->execute();
  
 header("Location:viewarchivedrepairs.php");
}
...
<html lang="en">
  ...
  ?></p>
                    ...
                    <div class="d-flex justify-content-between flex-wrap">
                      ...
                      <div>
                        <div class="d-flex flex-wrap pt-2 justify-content-between sales-header-right">
                            <h3>View all archived repairs</h3>
                       <p>
              </div>
    ...
    <tbody>
 <?php
 $select_stmt=$db->prepare("SELECT * FROM archived_repairs"); //sql select query
 $select_stmt->execute();
