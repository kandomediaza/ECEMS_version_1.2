...
<html lang="en">
 ...
 ?>
        ...
        <tr>
            <td>JC<?php echo $row['job_number']; ?></td>
             <td><?php echo $row['date']; ?></td>
             <td><?php echo $row['client_full_name']; ?></td>
             <td><?php echo $row['item_for_repair']; ?></td>
             <td><?php echo $row['current_status']; ?></td>
              
            <td><a href="editrepairs_tech.php?update_id=<?php echo $row['job_number']; ?>" class="btn btn-success" onclick="return confirm('Please be careful when editing this job card! Do not remove important information.. Click OK if you understand....');">View | Edit</a></td>
