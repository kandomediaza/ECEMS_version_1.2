...
<html lang="en">
  ...
  ?></p>
          ...
          <div class="content-wrapper pb-0">
            <div class="page-header flex-wrap">
              <div class="header-left">
                  <a href="addnewuser.php" class="btn btn-outline-primary mb-2 mb-md-0" role="button">Add New User</a>
    ...
    <tbody>
 <?php
 $select_stmt=$db->prepare("SELECT * FROM masterlogin"); //sql select query
 $select_stmt->execute();
 ...
 ?>
        ...
        <tr>
            ...
            <td><a href="editusers.php?update_id=<?php echo $row['id']; ?>" class="btn btn-success" onclick="return confirm('You are about to edit this user. Press OK to continue');">View | Edit</a></td>
            <td><a href="?delete_id=<?php echo $row['id']; ?>" class="btn btn-danger" onclick="return confirm('Are you REALLY sure you want to delete this user? Press Cancel if this was a mistake, or press OK to delete this user from ECEMS');">Delete</a></td>
