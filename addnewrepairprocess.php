...
if(isset($_POST['btn_create']))
{
    ...
    $item_for_repair = filter_var($_POST['item_for_repair'], FILTER_SANITIZE_STRING);
    $repair_description = filter_var($_POST['repair_description'], FILTER_SANITIZE_STRING);
    $hardware_details = filter_var($_POST['hardware_details'], FILTER_SANITIZE_STRING);
    $diagnostic_fee = filter_var($_POST['diagnostic_fee'], FILTER_SANITIZE_STRING);
    $tech_assigned = filter_var($_POST['tech_assigned'], FILTER_SANITIZE_STRING);
    $current_status = filter_var($_POST['current_status'], FILTER_SANITIZE_STRING);
    $technician_notes = filter_var($_POST['technician_notes'], FILTER_SANITIZE_STRING);
    $admin_notes = filter_var($_POST['admin_notes'], FILTER_SANITIZE_STRING);
    $invoice_status = filter_var($_POST['invoice_status'], FILTER_SANITIZE_STRING);
